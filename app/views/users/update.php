            ...
            <div class="card-body">
                <form action="<?= site_url('users/update/' . $user['id']) ?>" method="POST">
                    <div class="form-group">
                        ...
                        <input type="text" name="username" id="username" value="<?= $user['username'] ?>" required placeholder="Enter adventurer name">
                    </div>
                    <div class="form-group">
                        <label for="email">📬 Contact Crystal</label>
                        <input type="email" name="email" id="email" value="<?= $user['email'] ?>" required placeholder="Enter crystal frequency">
                    </div>
                    <div class="actions">
